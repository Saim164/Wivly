...
const VIDEO_TYPES = ["mp4", "webm", "quicktime", "mov"];
...
export default function PostCard({
  ...
  return (
    <div className={styles.card}>
      ...
      {post.media &&
        (isVideo ? (
          <video className={styles.media} src={mediaUrl(post.media)} controls />
        ) : (
          <img
      ...
      <p className={styles.likeCount}>{likes.length} likes</p>

      <div className={styles.actions}>
        <button
          type="button"
          className={`${styles.actionButton} ${isLiked ? styles.actionActive : ""}`}
