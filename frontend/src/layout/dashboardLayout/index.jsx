...
import { getAboutUser, getTopUsers } from "@/config/redux/authSlice";
import { getAllPosts } from "@/config/redux/postSlice";
        ...
        <div className={styles.topUserList}>
          {topUsers.map((person) => (
            ...
            >
              ...
              />
              <div>
                <p className={styles.topUserName}>{person.name}</p>
                <p className={styles.topUserUsername}>@{person.username}</p>
              </div>
            </div>
          ))}
        </div>
